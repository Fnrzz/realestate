  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <button className="relative z-10 touch-manipulation w-full sm:w-[120px] md:w-[80px] h-[200px] md:h-[50px] overflow-hidden rounded-4xl lg:rounded-full shrink-0 group">
          <Image
            key={videoThumb}
            src={videoThumb}
            alt="video-thumbnail"
            ...
            className="object-cover object-center transition-transform duration-300 group-hover:scale-105 pointer-events-none animate-in fade-in"
          />
